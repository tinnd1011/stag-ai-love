...
import CryptoSignalsChart from "../trend-chart";
import ChartComponent from "../trend-chart";
import AltsBuySignalChart from "../trend-chart";
import AltsBuySignalTimelineChart from "../trend-chart";
import TimelineChart from "../trend-chart";
...
const Crypto = () => {
    ...
    return (
        <main>
            <HeadComponent icon={crypto} title="Crypto Buy Signal " />
